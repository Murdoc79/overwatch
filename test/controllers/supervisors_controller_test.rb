...
class SupervisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supervisor" do
    assert_difference('Supervisor.count') do
      post supervisors_url, params: { supervisor: { name: @supervisor.name, phone: @supervisor.phone } }
    end
  ...
  test "should update supervisor" do
    patch supervisor_url(@supervisor), params: { supervisor: { name: @supervisor.name, phone: @supervisor.phone } }
